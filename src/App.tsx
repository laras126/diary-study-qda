...
<div className="hidden md:flex">
      ...
      <main className={`flex-1 min-h-0 ${currentView === 'code' ? 'overflow-hidden' : 'overflow-y-auto'}`}>
        ...
        {currentView !== 'code' && (
          <footer className="border-t border-gray-300 bg-gray-100 px-5 py-2.5 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-gray-600">
            <span>
              Made by{' '}
              <a href="https://larakarki.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900 underline underline-offset-2">
                Lara Karki
              </a>
              {' '}for{' '}
              <a href="https://laras126.github.io/cog-sci-and-llms/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900 underline underline-offset-2">
